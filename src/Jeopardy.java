...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel header = createHeader("Shapes");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed == firstButton){
			...
			askQuestion("How many sides are there on a square? (Spell it out)", "four", 200);
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("How many angles are in an octogon? (Spell it out)", "eight", 400);
			secondButton.removeActionListener(this);
		}
		
		else if(buttonPressed == thirdButton){
			askQuestion("What 2D shape has 5 sides?", "Pentagon", 600);
			thirdButton.removeActionListener(this);
		}
		
		else if(buttonPressed == fourthButton){
			askQuestion("What do you call a perfectly round 3D shape that looks like a ball", "Sphere", 800);
			fourthButton.removeActionListener(this);
			
		}
		else if(buttonPressed == fifthButton){
			askQuestion("What shape is the base of a cylinder?", "circle", 1000);
